...
namespace Denovo
{
    ...
    public partial class Expenses : UserControl
    {
        ...
        private void LoadExpenses()
        {
            try
            {
                using (SqlConnection conn = DBUtils.GetDBConnection())
                {
                    ...
                    using (var da = new SqlDataAdapter("SELECT Code, Date, Description, [Amount (R)], Employee FROM Expenses", conn))
                    {
                        dt = new DataTable();
                        da.Fill(dt);
                    }
        ...
        {
            ExpensesAdd expAdd = new ExpensesAdd();
        ...
        private void BtnEdit_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var row = (DataRowView)DGExpenses.SelectedItem;

                ExpensesEdit expEdit = new ExpensesEdit();
                expEdit.SetSelectedExpense(row[0].ToString());
            ...
            else MessageBox.Show("Please select an expense.", "Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
        }
        ...
        private void CalculateTotal()
        {
            ...
            TxtTotal.Text = total.ToString("N2", nfi);
        }
